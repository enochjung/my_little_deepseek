...
pub unsafe fn argmax_n_avx512(x: *const f32, n: usize) -> u32 {
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn cast_bf16_to_f32_n_n_avx512(dst: *mut f32, src: *const (), n: usize) {
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn rms_n_avx512(x: *const f32, n: usize) -> f32 {
    let vec_end = unsafe { x.add(n & !15) };
    let end = unsafe { x.add(n) };
    let mut ptr = x;
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn mul_n_n_avx512(y: *mut f32, x: *const f32, alpha: f32, n: usize) {
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn add_n_n_avx512(y: *mut f32, x: *const f32, n: usize) {
    let x_vec_end = unsafe { x.add(n & !15) };
    let x_end = unsafe { x.add(n) };
    let mut y = y;
    let mut x = x;
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn silu_n_avx512(x: *mut f32, n: usize) {
    let vec_end = unsafe { x.add(n & !15) };
    let end = unsafe { x.add(n) };
    let mut ptr = x;
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn safe_softmax_with_masking_n_avx512(x: *mut f32, alpha: f32, n_mask: usize, n: usize) {
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn rope_cos_n_avx512(x: *mut f32, n: usize, k: f32, theta: f32, d: f32) {
    let vec_end = unsafe { x.add(n & !15) };
    let end = unsafe { x.add(n) };
    let mut ptr = x;
    let mut i: usize = 0;
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn rope_sin_n_avx512(x: *mut f32, n: usize, k: f32, theta: f32, d: f32) {
    let vec_end = unsafe { x.add(n & !15) };
    let end = unsafe { x.add(n) };
    let mut ptr = x;
    let mut i: usize = 0;
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn mul_rmn_rmk_rkn_avx512(
    c: *mut f32,
    ldc: u32,
    a: *const f32,
    lda: u32,
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn mul_rmn_rmk_ckn_avx512(
    c: *mut f32,
    ldc: u32,
    a: *const f32,
    lda: u32,
...
#[cfg(target_arch = "x86_64")]
#[target_feature(enable = "avx512f")]
pub unsafe fn mul_rmn_rmk_ckn_r1n_avx512(
    d: *mut f32,
    ldd: u32,
    a: *const f32,
    lda: u32,
