...
mod avx512f {
    ...
    // y[0..n] = a[0..n] + b[0..n]
    pub unsafe fn elem_add(y: *mut bf16, a: *const bf16, b: *const bf16, n: usize) {
        for i in 0..n {
    ...
    // y = safe_softmax(y)
    pub unsafe fn safe_softmax(y: *mut bf16, n: usize) {
        let mut max_val = bf16::NEG_INFINITY;
        for i in 0..n {
                    ...
                    for i in ii..i_end {
                        for j in jj..j_end {
                            ...
                            for p in pp..p_end {
                                unsafe {
                                    sum +=
                                        *a.add(i * lda as usize + p) * *b.add(p * ldb as usize + j)
                                };
                            }
                    ...
                    for i in ii..i_end {
                        for j in jj..j_end {
                            ...
                            for p in pp..p_end {
                                unsafe {
                                    sum +=
                                        *a.add(i * lda as usize + p) * *b.add(j * ldb as usize + p)
                                };
                            }
                            unsafe { *y.add(i * ldy as usize + j) += sum };
                        }
                    ...
                    for i in ii..i_end {
                        for j in jj..j_end {
                            ...
                            for p in pp..p_end {
                                unsafe {
                                    sum +=
                                        *a.add(p * lda as usize + i) * *b.add(p * ldb as usize + j)
                                };
                            }
                            unsafe { *y.add(i * ldy as usize + j) += sum };
                        }
                    ...
                    for i in ii..i_end {
                        for j in jj..j_end {
                            ...
                            for p in pp..p_end {
                                unsafe {
                                    sum +=
                                        *a.add(p * lda as usize + i) * *b.add(j * ldb as usize + p)
                                };
                            }
                            unsafe { *y.add(i * ldy as usize + j) += sum };
                        }
