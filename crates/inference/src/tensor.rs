use core::{Backend, ElemType, MLTError, MatrixLayout, Memory, MemoryMut, MemoryOwn};

use std::ops::Range;

pub struct Tensor<T: ElemType, M: Memory<T>> {
    mem: M,
    ml: MatrixLayout<T>,
}

impl<T: ElemType, M: Memory<T>> Tensor<T, M> {
...
impl<T: ElemType, MO: MemoryOwn<T>> Tensor<T, MO> {
    pub fn reshape(
        &mut self,
        nrow: u32,
        ncol: u32,
...
type BackendOf<T, MM> = <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend;
...
impl<T: ElemType, MM: MemoryMut<T>> Tensor<T, MM> {
    ...
    pub fn add_assign<S0: Memory<T, Base = MM::Base>>(
        ...
        if self.ml.nrow == other.ml.nrow && self.ml.ncol == other.ml.ncol {
            unsafe {
                BackendOf::<T, MM>::elem_add_assign(&mut self.mem, &self.ml, &other.mem, &other.ml)
            };
        } else if self.ml.ncol == other.ml.ncol && other.ml.nrow == 1 {
            unsafe {
                BackendOf::<T, MM>::elem_br_add_assign(
                    &mut self.mem,
                    &self.ml,
                    &other.mem,
                    &other.ml,
    ...
    pub fn argmax(&self) -> Result<u32, MLTError> {
        ...
        Ok(unsafe { BackendOf::<T, MM>::argmax(&self.mem, &self.ml) })
    }
    ...
    pub fn copy<S0: Memory<T, Base = MM::Base>>(
        ...
        unsafe { BackendOf::<T, MM>::copy(&mut self.mem, &self.ml, &other.mem, &other.ml) };
        Ok(())
    }
    ...
    pub fn fill(&mut self, value: T) {
        unsafe { BackendOf::<T, MM>::fill(&mut self.mem, &self.ml, value) };
    }
    ...
    pub fn scalar_mul_assign(&mut self, value: T) {
        unsafe { BackendOf::<T, MM>::scalar_mul_assign(&mut self.mem, &self.ml, value) };
    }
    ...
    pub fn elem_mul<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        unsafe {
            BackendOf::<T, MM>::elem_mul(&mut self.mem, &self.ml, &a.mem, &a.ml, &b.mem, &b.ml)
        };
        Ok(())
    }
    ...
    pub fn elem_muladd_assign<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(b.ml.nrow, b.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            BackendOf::<T, MM>::elem_muladd_assign(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    pub fn elem_mulsub_assign<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(b.ml.nrow, b.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            BackendOf::<T, MM>::elem_mulsub_assign(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    pub fn elem_mul_assign<S0: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(other.ml.nrow, other.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            BackendOf::<T, MM>::elem_mul_assign(&mut self.mem, &self.ml, &other.mem, &other.ml)
        };
        Ok(())
    }
    ...
    pub fn matmul<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        unsafe {
            BackendOf::<T, MM>::matmul(&mut self.mem, &self.ml, &a.mem, &a.ml, &b.mem, &b.ml)
        };
        Ok(())
    }
    ...
    pub fn matmul_assign<S0: Memory<T, Base = MM::Base>>(
        ...
        unsafe {
            BackendOf::<T, MM>::matmul_assign(&mut self.mem, &self.ml, &other.mem, &other.ml)
        };
        Ok(())
    }
    ...
    pub fn rms_norm<S0: Memory<T, Base = MM::Base>>(
        ...
        unsafe {
            BackendOf::<T, MM>::rms_norm(&mut self.mem, &self.ml, &weight.mem, &weight.ml, epsilon)
        };
        Ok(())
    }
    ...
    pub fn rope_vector(
        ...
        let k = T::from_u32(token_index);
        let d = T::from_u32(head_size);

        unsafe {
            BackendOf::<T, MM>::rope_cos(&mut dst0.mem, &dst0.ml, k, rope_theta, d);
            BackendOf::<T, MM>::rope_sin(&mut dst1.mem, &dst1.ml, k, rope_theta, d);
        };
        Ok(())
    }
    ...
    pub fn safe_softmax(&mut self) {
        unsafe { BackendOf::<T, MM>::safe_softmax(&mut self.mem, &self.ml) };
    }
    ...
    pub fn silu(&mut self) {
        unsafe { BackendOf::<T, MM>::silu(&mut self.mem, &self.ml) };
    }

    /*
    // self += other.
    // when one shape of self & other (nrow or ncol) matches, then expand another shape then add_assign.
    pub fn add_assign<S0: Memory<T, Base = MM::Base>>(
        &mut self,
        other: &Tensor<T, S0>,
    ) -> Result<(), MLTError> {
        validate_shape(other.ml.nrow, other.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::elem_add_assign(
                &mut self.mem,
                &self.ml,
                &other.mem,
                &other.ml,
    ...
    pub fn argmax(&self) -> Result<u32, MLTError> {
        validate_shape(self.ml.nrow, self.ml.ncol, 1, self.ml.ncol)?;
        Ok(unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::argmax(&self.mem, &self.ml)
        })
    }
    ...
    pub fn copy<S0: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(other.ml.nrow, other.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::copy(
                &mut self.mem,
                &self.ml,
                &other.mem,
                &other.ml,
    ...
    pub fn fill(&mut self, value: T) {
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::fill(&mut self.mem, &self.ml, value)
        }
    }
    ...
    pub fn scalar_mul_assign(&mut self, value: T) {
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::scalar_mul_assign(
                &mut self.mem,
                &self.ml,
                value,
            )
    ...
    pub fn elem_mul<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(b.ml.nrow, b.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::elem_mul(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    pub fn elem_muladd_assign<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(b.ml.nrow, b.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::elem_muladd_assign(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    pub fn elem_mulsub_assign<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(b.ml.nrow, b.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::elem_mulsub_assign(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    pub fn elem_mul_assign<S0: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(other.ml.nrow, other.ml.ncol, self.ml.nrow, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::elem_mul_assign(
                &mut self.mem,
                &self.ml,
                &other.mem,
                &other.ml,
    ...
    pub fn mul<S0: Memory<T, Base = MM::Base>, S1: Memory<T, Base = MM::Base>>(
        &mut self,
        a: &Tensor<T, S0>,
        b: &Tensor<T, S1>,
    ) -> Result<(), MLTError> {
        validate_shape(self.ml.nrow, self.ml.ncol, a.ml.nrow, b.ml.ncol)?;
        validate_shape(a.ml.nrow, a.ml.ncol, self.ml.nrow, b.ml.nrow)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::matmul(
                &mut self.mem,
                &self.ml,
                &a.mem,
                &a.ml,
    ...
    // self = self * other
    pub fn mul_assign<S0: Memory<T, Base = MM::Base>>(
        &mut self,
        other: &Tensor<T, S0>,
    ) -> Result<(), MLTError> {
        validate_shape(self.ml.ncol, self.ml.ncol, other.ml.nrow, other.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::matmul_assign(
                &mut self.mem,
                &self.ml,
                &other.mem,
                &other.ml,
    ...
    pub fn rms_norm<S0: Memory<T, Base = MM::Base>>(
        ...
        validate_shape(weight.ml.nrow, weight.ml.ncol, 1, self.ml.ncol)?;
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::rms_norm(
                &mut self.mem,
                &self.ml,
                &weight.mem,
                &weight.ml,
    ...
    pub fn rope_vector(
        ...
        let d = T::from_u32(head_size);
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::rope_cos(
                &mut dst0.mem,
                &dst0.ml,
                k,
                rope_theta,
            ...
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::rope_sin(
                &mut dst1.mem,
                &dst1.ml,
                k,
                rope_theta,
    ...
    // self = safe_softmax(self).
    pub fn safe_softmax(&mut self) {
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::safe_softmax(
                &mut self.mem,
                &self.ml,
            )
        };
    ...
    // self[i,j] / (1 + e^(-self[i,j]))
    pub fn silu(&mut self) {
        unsafe {
            <<MM as Memory<T>>::Base as MemoryOwn<T>>::Backend::silu(&mut self.mem, &self.ml)
        };
    }
    */
}

fn validate_space<T: ElemType>(mem_size: usize, ml: &MatrixLayout<T>) -> Result<(), MLTError> {
...
where
    T: std::ops::Sub + PartialEq + std::fmt::Debug,
{
    ...
    pub fn assert<const N: usize>(&self, answer: &[[T; N]]) {
        ...
        for i in 0..self.ml.nrow as usize {
            for j in 0..self.ml.ncol as usize {
                ...
                let actual = unsafe { *(ptr.add(self.ml.col_stride as usize * j)) };
                assert!(
                    actual == expected,
...
mod tests {
    ...
    fn build_tensor<T: ElemType>(value: &[T], ml: MatrixLayout<T>) -> Tensor<T, Mmap<T>> {
        let mut mem = Mmap::new(value.len()).expect("Failed to allocate Mmap");
    ...
    fn cast_bf16_to_f32() {
        ...
        /*
        let src = build_tensor(&[1.0f16, 2.0, 3.0, 4.0], MatrixLayout::new(0, 2, 2, 2, 1));
        let mut dst = build_tensor(&[0.0f32, 0.0, 0.0, 0.0], MatrixLayout::new(0, 2, 2, 2, 1));
        dst.cast_from_bf16(&src).expect("Failed to cast tensor");
